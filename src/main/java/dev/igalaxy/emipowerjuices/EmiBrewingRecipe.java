...
public class EmiBrewingRecipe implements EmiRecipe {
	...
	public void addWidgets(WidgetHolder widgets) {
		...
		widgets.addAnimatedTexture(BACKGROUND, 81, 2, 9, 28, 176, 0, 1000 * 20, false, false, false).tooltip((mx, my) -> List.of(TooltipComponent.of(Text.translatable("emi.cooking.time", 20).asOrderedText())));
